...
;(function ($) {
	$.fn.camera = function (opts, callback) {
		...
		var defaults = {
			...
			onEndTransition: function onEndTransition() {}, //this callback is invoked when the transition effect ends

			onLoaded: function onLoaded() {}, //this callback is invoked when the image on a slide has completely loaded

			onStartLoading: function onStartLoading() {}, //this callback is invoked when the image on a slide start loading

			onStartTransition: function onStartTransition() {} //this callback is invoked when the transition effect starts
		...
		if (elem.length != 0) {
			var _imgFake = function _imgFake() {
